...
use App\Modules\Core\Models\PostRevision;
use App\Modules\Core\Models\PostData;
use App\Modules\Core\Models\PostTag;
use App\Modules\Core\Models\PostRelated;
...
class Post extends Model
{
    ...
    {
        return $this->hasMany('App\Modules\Core\Models\PostData');
    }
    ...
    {
        return $this->hasMany('App\Modules\Core\Models\PostRevision');
    }

    public function relatedPosts()
    {
        return $this->hasMany('App\Modules\Core\Models\PostRelated', 'from_post_id');
    }

    public function category()
    {
        return $this->belongsTo('App\Modules\Core\Models\Category');
    }
