  ...
  <div class="extra content">
    <div class="ui center aligned">
      <div class="ui buttons mobile only tablet only">
        <a
          href="{{ route(($module->module_type == 'plugin' ? 'admin.updates.install_plugin' : 'admin.updates.install_theme'), [ 'id' => $module->id ]) }}"
          class="small ui button primary">
          Install
        </a>
      ...
      <div class="ui buttons computer only">
        ...
        <a href="https://www.adaptcms.com/community/forum/{{ $module->slug }}"
