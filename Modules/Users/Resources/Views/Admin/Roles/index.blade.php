...
@section('content')
  ...
  <a href="{{ route('admin.roles.add') }}" class="ui right labeled icon button small primary pull-right">
    Add
    <i class="plus icon"></i>
  </a>
  ...
  @else
    ...
    <table class="ui stackable compact celled table">
      ...
      @foreach($items as $item)
        <tr>
          <td>
            <a href="{{ route('admin.roles.edit', [ 'id' => $item->id ]) }}"><strong>{{ $item->name }}</strong></a>
          </td>
