      ...
      <div class="twelve wide column">
        ...
        <div id="main-container" class="ui fluid red left aligned raised padded text container segment pull-left">
          <a href="{{ request()->headers->get('referer') }}"
             class="ui left labeled icon button large violet margin-bottom-10 right floated">
            Back
...
<script type="text/javascript"
        src="//cdnjs.cloudflare.com/ajax/libs/codemirror/5.29.0/mode/javascript/javascript.min.js"></script>
<script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/codemirror/5.29.0/mode/sass/sass.min.js"></script>
<script type="text/javascript"
        src="//cdnjs.cloudflare.com/ajax/libs/codemirror/5.29.0/mode/scheme/scheme.min.js"></script>
