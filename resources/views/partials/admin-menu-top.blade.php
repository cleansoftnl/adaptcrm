<a href="{{ route('admin.updates.index') }}"
   class="{{ Route::currentRouteName() == 'admin.updates.index' ? 'active' : '' }} item" data-tooltip="Updates"
...
<a href="{{ route('admin.updates.browse') }}"
   class="{{ Route::currentRouteName() == 'admin.updates.browse' ? 'active' : '' }} item" data-tooltip="Marketplace"
   data-position="bottom center" data-inverted>
